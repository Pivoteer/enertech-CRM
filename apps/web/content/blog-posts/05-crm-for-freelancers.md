...
That's what AI agent does. It connects to your Enertech CRM and handles the data entry, the note-taking, the follow-up scheduling, and the pipeline updates. You talk to your agent in plain language. The CRM stays current without you ever opening it.
...
Enertech CRM is a self-hosted, open-source CRM with native agent integration. It has everything a freelancer needs: contacts, companies, deals (or projects), tasks, notes, custom fields, pipeline views, and a built-in AI assistant.
...
## Setting Up Enertech as a Freelancer
...
- Upload to Enertech CRM, map the columns, import

### Connect Your AI agent (2 Minutes)

This is where the freelancer workflow changes completely. For the full walkthrough, see [How to Connect Your AI agent to Enertech CRM in 2 Minutes](/blog/connect-ai-agent-to-crm).

1. Go to Settings in your Enertech CRM
...
The difference isn't the CRM itself. Enertech has the same core features as any good CRM: contacts, deals, tasks, notes, pipeline views. The difference is how the data gets in.
...
## Enertech vs. Other Freelancer CRM Options

| CRM | Agent Integration | Self-Hosted | Price | Best For |
|-----|-------------------|-------------|-------|----------|
| **Enertech CRM** | Native (AI agent) | Yes | Open-source ($10/mo hosting) | Freelancers who want agent-first CRM |
...
The key difference: Enertech is the only option where your AI agent can manage the CRM for you. Every other tool requires you to do the data entry yourself.
...
### Can I use Enertech CRM without the agent?
...
Enertech CRM is a web app that works on mobile browsers. Your AI agent works from wherever you've connected it, so if you talk to your agent from your phone (such as through a messaging app or terminal), you can manage your CRM from anywhere.

## Getting Started

1. **Deploy Enertech CRM:** `docker compose up -d` and seed the database.
...
[Try Enertech (Free, Self-Hosted)](https://github.com/Pivoteer/enertech-CRM) | [Live Demo](https://enertech-crm.vercel.app) | [Documentation](https://enertech-crm.vercel.app/docs)
