...
|:----:|-----|----------|---------------------|---------|
| 1 | **Enertech CRM** | Teams running AI agents | Native (skill file, 2-min setup) | MIT |
...
## 1. Enertech CRM: Native Agent Integration

**GitHub:** [Pivoteer/enertech-CRM](https://github.com/Pivoteer/enertech-CRM) | **Stack:** Next.js 15, PostgreSQL, TypeScript | **License:** MIT

Enertech is a self-hosted CRM built for the agent era. Standard CRM features (contacts, companies, deals, tasks, notes), but the real differentiator is native integration with AI agent.
...
Two AI layers: AI agent handles things when you're outside the CRM. The built-in assistant handles things when you're inside it. For a technical deep-dive into both systems, see [Two Ways AI Works in Enertech CRM](/blog/how-we-built-ai-into-crm).
...
| Feature | Enertech | Twenty | EspoCRM | SuiteCRM | Monica |
|---------|:--------:|:------:|:-------:|:--------:|:------:|
...
Today, only Enertech checks all of those boxes. Twenty and EspoCRM have the API foundation, and a developer could build agent integrations for them. But "could" and "does" are different things.
...
|---------|--------------|-----------------|
| **MIT** (Enertech CRM) | None | Fork it, modify the API, build custom integrations, keep changes private. Maximum flexibility. |
...
**Choose Enertech if** you're running an AI agent (or plan to), want your agent managing your CRM, value modern UX and MIT license flexibility, and can wait on email sync.
...
We contribute to Enertech CRM, so take this with appropriate context. The reasoning:

1. **Your agent should run your CRM.** AI agents working across your tool stack, with CRM as one of those tools. Enertech supports this natively.
...
The tradeoff is maturity. Twenty has a bigger community. EspoCRM has more features. But Enertech is the only one building for the agent-first future, and that's the axis that matters most in 2026.
...
For most open-source CRMs, the answer is "maybe, with work." For Enertech CRM, it's "yes, in 2 minutes."
...
- [How to Connect Your AI agent to Enertech CRM in 2 Minutes](/blog/connect-ai-agent-to-crm)
...
- [Enertech CRM](https://github.com/Pivoteer/enertech-CRM)
