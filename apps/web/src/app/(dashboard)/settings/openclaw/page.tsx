...
export default function OpenClawPage() {
  ...
  const skillMd = useMemo(() => {
    const url = instanceUrl || "https://your-enertech-crm-instance.com";
    return `---
name: enertech
description: Interact with Enertech CRM — manage workspaces, records, contacts, companies, deals, tasks, notes, and lists.
homepage: ${url}
user-invocable: true
metadata:
  clawdbot:
...
You have access to an Enertech CRM instance. Use its REST API to help users manage their workspaces, contacts, companies, deals, tasks, notes, and lists.

## Configuration

- **Base URL**: \`$ENERTECH_API_URL\` (e.g. \`${url}\`)
- **Auth**: Bearer token via \`$ENERTECH_API_KEY\`
- All requests use \`Authorization: Bearer $ENERTECH_API_KEY\` header
...
`;
    ...
    return JSON.stringify(
      {
        skills: {
          openclaw: {
            enabled: true,
            env: {
              ENERTECH_API_URL: url,
              ENERTECH_API_KEY: selectedKey
  ...
  const installCmd = `mkdir -p ~/.openclaw/skills/enertech && cp SKILL.md ~/.openclaw/skills/enertech/SKILL.md`;
  ...
  return (
    <div className="max-w-3xl">
      <div className="mb-6">
        <h1 className="text-xl font-semibold">Agent integration</h1>
        <p className="text-sm text-muted-foreground mt-1">
          Generate a skill file to connect your Enertech CRM instance with{" "}
          <a
          ...
          . This lets AI agents interact with your CRM data.
        </p>
      </div>
      ...
      <div className="space-y-6">
          ...
          <div className="space-y-3">
            <div className="space-y-1.5">
              ...
              <p className="text-xs text-muted-foreground">
                The URL where your Enertech CRM instance is accessible.
              </p>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              {apiKeys.length > 0 ? (
                ...
                <div className="rounded-md border border-dashed p-3 text-sm text-muted-foreground">
                  ...
                  to use with your AI agent.
                </div>
              )}
              <p className="text-xs text-muted-foreground">
                The API key Enertech will use to authenticate. Create keys in{" "}
                <a
                  href="/settings/api-keys"
                  className="underline hover:text-foreground"
                >
        ...
        <section className="rounded-lg border p-4 space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h2 className="font-medium">Agent config</h2>
            </div>
            <Button
              variant="outline"
              size="sm"
        ...
        <section className="rounded-lg border p-4 space-y-4">
          ...
          <p className="text-sm text-muted-foreground">
            After downloading the SKILL.md, install it to your Enertech skills directory:
          </p>
          ...
          <div className="rounded-md border border-neutral-300/50 bg-neutral-50 p-3 text-sm space-y-2">
            ...
            <ol className="list-decimal pl-5 space-y-1 text-muted-foreground text-xs">
              ...
              <li>Place it at <code className="bg-muted px-1 py-0.5 rounded">~/.openclaw/skills/enertech/SKILL.md</code></li>
              ...
              <li>Restart Enertech — the agent can now interact with your CRM</li>
            </ol>
          </div>
        </section>
      </div>
