...
export default async function ComparisonPage({
  ...
  const articleSchema = {
    ...
    author: { "@type": "Organization", name: "Enertech CRM" },
    publisher: { "@type": "Organization", name: "Enertech CRM" },
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": `${baseUrl}/compare/${slug}`,
    },
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: page.meta.title },
    ],
  };
    ...
    <div className="relative min-h-screen bg-background text-foreground">
      ...
      <section className="relative mx-auto max-w-3xl px-6 pt-32 pb-8 sm:pt-40 sm:pb-10">
        ...
        <nav className="mb-6 flex items-center gap-1.5 text-[13px] text-muted-foreground/50">
          ...
          <span>/</span>
          <span className="text-muted-foreground/70">Compare</span>
          <span>/</span>
